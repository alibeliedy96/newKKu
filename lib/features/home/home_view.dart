                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              height: 24.h,
                              width: 90.h,
                              child: now.hour >= 5 && now.hour < 10 ? CountdownTimerWidget(
                                color: Colors.blue,
                                fontSize: 16.0,
                              ) : Center(
                                child: Text(
                            ...
                            // SizedBox(height: 5.h),
                            Image.asset(
                              'assets/images/Image Container (1).png',
                              height: 95,
                            )
                          ],
                        ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 10.h),
                              Image.asset(
                                'assets/images/Image Container (3).png',
                              )
                            ],
                          ),
                        ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // SizedBox(height: 5.h),
                              Image.asset(
                                'assets/images/Image Container (2).png',
                                height: 170,
                              )
                            ],
                          ),
